...
assert BOT_TOKEN, "TELEGRAM_BOT_TOKEN belum diset di .env"
assert GROQ_API_KEY, "GROQ_API_KEY belum diset di .env"
assert os.getenv("JINA_API_KEY"), "JINA_API_KEY belum diset di .env"
